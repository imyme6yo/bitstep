    ...
    <>
      ...
      <main>
        <div className="container p-10">
          ...
          <div className="text-lg font-bold my-3">제3조 약관 외 준칙</div>
          <div className="flex flex-col gap-1">
            <div>
          ...
          <div className="text-lg font-bold my-3">제4조 이용계약 체결</div>
          <div className="flex flex-col gap-1">
            <div>
          ...
          <div className="text-lg my3">제6조 개인정보처리방침</div>
          <div className="flex flex-col gap-1">
            <div>
          ...
          <div className="text-lg font-bold my-3">제7조 운영자의 의무</div>
          <div className="flex flex-col gap-1">
            <div>
          ...
          <div className="text-lg font-bold my-3">제8조 회원의 의무</div>
          <div className="flex flex-col gap-1">
            <div>
          ...
          <div className="text-lg font-bold my-3">제9조 서비스 이용 시간</div>
          <div className="flex flex-col gap-1">
            <div>
          ...
          <div className="text-lg font-bold my-3">제10조 서비스 이용 해지</div>
          <div className="flex flex-col gap-1">
            <div>
          ...
          <div className="text-lg font-bold my-3">제11조 서비스 이용 제한</div>
          <div className="flex flex-col gap-1">
            <div>
            ...
            <div>② 타인의 사이트 이용을 방해하거나 정보를 도용하는 행위</div>
            <div>③ 사이트의 운영진, 직원 또는 관계자를 사칭하는 행위</div>
            <div>
              ④ 사이트, 기타 제3자의 인격권 또는 지적재산권을 침해하거나 업무를
              방해하는 행위
            </div>
            <div>⑤ 다른 회원의 ID를 부정하게 사용하는 행위</div>
            <div>
              ⑥ 다른 회원에 대한 개인정보를 그 동의 없이 수집, 저장, 공개하는
              행위
            </div>
            <div>⑦ 범죄와 결부된다고 객관적으로 판단되는 행위</div>
            <div>⑧ 기타 관련 법령에 위배되는 행위</div>
          </div>
          <div className="text-lg font-bold my-3">제12조 게시물의 관리</div>
          <div className="flex flex-col gap-1">
            <div>
            ...
            <div>- 불법 복제 또는 해킹을 조장하는 내용인 경우</div>
            <div>- 영리를 목적으로 하는 광고일 경우</div>
            <div>- 범죄와 결부된다고 객관적으로 인정되는 내용일 경우</div>
            <div>
              - 다른 이용자 또는 제3자와 저작권 등 기타 권리를 침해하는 경우
            </div>
            <div>- 기타 관계 법령에 위배된다고 판단되는 경우</div>
            <div>
          ...
          <div className="text-lg font-bold my-3">제13조 게시물의 보관</div>
          <div className="flex flex-col gap-1">
          ...
          <div className="text-lg font-bold my-3">제15조 손해배상</div>
          <div className="flex flex-col gap-1">
            <div>
          ...
          <div className="text-lg font-bold my-3">제16조 면책</div>
          <div className="flex flex-col gap-1">
            <div>
          ...
          <div className="text-lg font-bold my-3">부칙</div>
          <div className="flex flex-col gap-1">
            이 약관은 2023. 1. 1일부터 시행합니다.
          </div>
        </div>
      </main>
    </>
