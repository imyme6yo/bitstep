...
const PrivacyPage = () => {
  return (
    <>
      <Head>
        <title>BITSTEP - 개인정보처리방침</title>
      </Head>
      <main>
        <div className="container h-100 p-10">
          <h1 className="text-xl font-bold my-3">개인정보처리방침</h1>
          <div>
            스몰브랜더(이하 ‘회사’라 한다)는 개인정보 보호법 제30조에 따라 정보
          ...
          <div>
            ...
            <div>- 표시․광고에 관한 기록 : 6월</div>
            <div>- 계약 또는 청약 철회, 대금결제, 재화 등의 공급기록 : 5년</div>
            <div>- 소비자 불만 또는 분쟁 처리에 관한 기록 : 3년</div>
            <div className="font-semibold">
          ...
          <div>
            ...
            <div>- 개인정보를 제공받는 자 : &lt;예) (주) OOO 카드&gt;</div>
            <div>
          ...
          <div>
            ...
            <div>1. 전화 상담 센터 운영</div>
            <div>- 위탁받는 자 (수탁자) : OOO CS센터</div>
            <div>
              - 위탁하는 업무의 내용 : 전화상담 응대, 부서 및 직원 안내 등
            </div>
            <div>2. A/S 센터 운영</div>
            <div>- 위탁받는 자 (수탁자) : OOO 전자</div>
            <div>- 위탁하는 업무의 내용 : 고객 대상 제품 A/S 제공</div>
            <div>
          ...
          <div className="text-lg font-bold my-3">제7조(개인정보의 파기)</div>
          <div>
            <div>
          ...
          <div>이 개인정보 처리방침은 2023. 1. 1부터 적용됩니다.</div>
        </div>
      </main>
    </>
  );
